...
const Footer = () => {
  return (
    <div>
      <footer className="footer footer-center mt-16 bg-gray-900 text-cyan-500 text-base-content rounded p-10 ">
  ...
  <aside>
    <p> &copy; 2025 - All right reserved by ACME Industries Ltd</p>
  </aside>
</footer>
    </div>
  )
